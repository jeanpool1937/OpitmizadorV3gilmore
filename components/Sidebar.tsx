...
import { Settings, Box, Scissors, Scale, AlertCircle, Factory, Split, Timer, Calendar } from 'lucide-react';
    ...
    <div className="w-full md:w-80 bg-slate-900 text-slate-100 flex-shrink-0 flex flex-col h-screen sticky top-0 overflow-y-auto border-r border-slate-700">
      ...
      <div className="p-6 space-y-6 flex-1">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-xs text-slate-400">Fecha Inicio Programa</label>
            <div className="flex items-center gap-2">
              ...
              <input 
                ...
                className="w-full bg-slate-800 border border-indigo-900/50 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 outline-none text-white"
              />
            </div>
          </div>
